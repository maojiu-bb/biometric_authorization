...
/**
 * Flutter plugin that provides biometric authentication functionality for macOS.
 * This plugin serves as the bridge between Flutter and native macOS authentication APIs.
 *
...
public class BiometricAuthorizationPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "getPlatformVersion":
            // Returns the macOS version for plugin verification
